...
public class Problem_11 {
	...
	public static long solution_1( long ){
	   ...
	   for(int j = 0; j <= 19; j++)
	   {
	           ...
	           if(D1 > M) {M = D1; D = "D1"; }
	           if(D2 > M) {M = D2; D = "D2"; }
	           if(N != M) { B[0] = i + 1; B[1] = 20 - j;}
	   }
	  // cout << "The greatest product of four numbers in a straight line is " << M << ". It begins at row " << B[0] << ", column " << B[1] << " and goes in direction " << D << "\n";
	...
	public static long solution_2(){
	    char grid[20][20]= {{8, 2, 22, 97, 38, 15, 0, 40, 0, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8},
